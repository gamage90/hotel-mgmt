...
public class RoomsDto {
    ...
    public RoomsDto(Integer roomID, Integer roomCatagory, String roomNumber, Integer roomAvailability, Double roomRate) {
        this.roomID = roomID;
    ...
    public String toString() {
        return "RoomsDto{" + "roomID=" + roomID + ", roomCatagory=" + roomCatagory + ", roomNumber=" + roomNumber + ", roomAvailability=" + roomAvailability + ", roomRate=" + roomRate + '}';
    }
